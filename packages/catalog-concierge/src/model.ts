...
export function resolveModelConfig(env: Record<string, string | undefined> = process.env): ModelConfig | null {
...
export function getModelClient(env: Record<string, string | undefined> = process.env): { client: OpenAI; model: string } | null {
